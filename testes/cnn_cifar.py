...
"""
model_path = './cnn/cnn_cifar10.pth'
"""
...
def generate_images(model, device, dataloader, num_images=5):
    model.eval()
    ...
    print('Predicted: ', ' '.join('%5s' % trainloader.dataset.classes[predicted[j]] for j in range(num_images)))
